...
function TermsOfService() {
  return (
    <>
      <div className="w-full min-h-screen overflow-x-hidden mb-[100px]">
        {/* Navigation */}
        <div className="w-full h-[55px] bg-[#006699] fixed top-0 z-50">
        ...
        {/* Content */}
        <div className="w-full flex flex-col items-center px-3 sm:px-5 md:px-10 mt-[55px]">
